...
public abstract class AbstractTemplateTestCase extends FunctionalTestCase {
	...
	protected static final String TEMPLATE_NAME = "sfdc2nets-account-broadcast";

	protected final Prober pollProber = new PollingProber(10000, 1000);
	...
	protected String buildUniqueName(String templateName) {
